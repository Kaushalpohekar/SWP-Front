...
private cards = [
  ...
  private formList = [
    { categoryID: '1234abcd-1234-abcd-1234-abcdef123456', formId: '48afd8d5-46b2-4736-b9ba-ae983cfae510', },
  ];
  private questions = [
    { 
  ...
  getFormsList(categoryID: string): Observable<any[]> {
    const filteredForms = this.formList.filter(form => form.categoryID === categoryID);
    return of(filteredForms);
  }
